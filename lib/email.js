...
async function sendEmail(options) {
  ...
  if (!isSMTPConfigured()) {
    ...
    console.log(`Body: ${options.text || (options.html ? options.html.substring(0, 200) + '...' : 'No body')}`);
    console.log('=============================================');
    return true;
  }
...
const EmailTemplates = {
   ...
   */
  inviteUser(inviterName, inviteUrl) {
